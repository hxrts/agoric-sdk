  ...
  const makeSeatInvite = () => {
    const seat = harden({
      addLiquidity: async () => {
        ...
        if (!hasValidPayoutRules(['offerAtMost', 'offerAtMost', 'wantAtLeast'], inviteHandle)) {
          throw rejectOffer(
            inviteHandle,
        ...
        // units in their offer rules as 'wantAtLeast'
      ...
      swap: () => {
        ...
        if (hasValidPayoutRules(['offerAtMost', 'wantAtLeast', 'wantAtLeast'], inviteHandle)) {
          ...
          hasValidPayoutRules(['wantAtLeast', 'offerAtMost', 'wantAtLeast'], inviteHandle)
        ) {
